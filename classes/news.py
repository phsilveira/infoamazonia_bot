...
class News:
            ...
            for page in iter(range(number_of_pages)):
                ...
                if response.ok:
                    for idx, item in enumerate(response.json()):
                        ...
                        news["collection_date"] = datetime.now(
                        ...
                        if set(["yoast_head_json"]).issubset(set(item.keys())):
                            ...
                            self.check_news_field(
                                yoast, news, "og_title", "Title", ""
                            )
                            self.check_news_field(
                                yoast,
                                news,
    ...
    def get_topics(self, news):
        ...
        try:
            ...
            news_topics = []
            if (
                news_subtopics.intersection(danos_ambientais)
                or "plenamata" in news["news_source"]
            ):
